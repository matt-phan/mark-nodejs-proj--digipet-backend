...
app.get("/digipet/train", (req, res) => {
    ...
    if (digipet) {
        ...
        res.json({
            message: "You just trained your digipet. It looks far more disciplined now!",
            digipet: model_1.getDigipet(),
        });
    }
    else {
        res.json({
            message: "Sorry, you don't have a digipet to train. Try hatching one with /digipet/hatch",
        });
    }
});
app.get("/digipet/feed", (req, res) => {
    ...
    if (digipet) {
        ...
        res.json({
            message: "Sorry, you don't have a digipet to feed. Try hatching one with /digipet/hatch",
        });
    }
});
app.get("/digipet/ignore", (req, res) => {
    ...
    if (digipet) {
        ...
        res.json({
            message: "Sorry, you don't have a digipet to ignore. Try hatching one with /digipet/hatch",
        });
    }
});
exports.default = app;
